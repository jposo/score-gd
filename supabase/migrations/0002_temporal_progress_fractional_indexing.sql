...
ALTER COLUMN "list_placement" TYPE numeric(40, 20)
USING (
  CASE
    WHEN "list_placement" IS NULL THEN NULL
    ELSE ("list_placement"::numeric * 1000)
  END
);
...
ADD CONSTRAINT "progress_history_user_id_users_id_fk"
FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;

--> statement-breakpoint
ALTER TABLE "progress_history"
ADD CONSTRAINT "progress_history_progress_id_progress_id_fk"
FOREIGN KEY ("progress_id") REFERENCES "public"."progress"("id") ON DELETE set null ON UPDATE no action;

--> statement-breakpoint
CREATE INDEX "progress_history_user_changed_at_index"
ON "progress_history" USING btree ("user_id", "changed_at");

--> statement-breakpoint
CREATE INDEX "progress_history_progress_id_index"
ON "progress_history" USING btree ("progress_id");

--> statement-breakpoint
CREATE INDEX "progress_active_list_order_index"
ON "progress" USING btree ("user_id", "status", "list_placement");
