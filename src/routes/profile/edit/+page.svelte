	...
	<div class="max-w-2xl mx-auto">
		...
		<div class="bg-base-100 rounded-lg shadow-lg p-6">
			<form method="POST" use:enhance={handleSubmit} class="space-y-6">
					...
					<div class="flex items-center gap-4">
						<div class="avatar">
							<div class="w-16 h-16 rounded-full">
								<img
									src={profilePictureUrl || "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp"}
				...
				<!-- Profile Picture URL -->
				<div class="form-control">
					<label class="label" for="profile_picture_url">
		...
		<div class="bg-base-100 rounded-lg shadow-lg p-6 mt-8">
			...
			<p class="text-base-content/70 mb-4">
				Need to change your password or delete your account? Contact support for assistance.
			</p>
